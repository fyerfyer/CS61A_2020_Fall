...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    if player_score<opponent_score and player_score+3>opponent_score:
        return True
    else:
        return False
    "*** YOUR CODE HERE ***"
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        ...
        if who==0:
            ...
            score0=score0+take_turn(num_roll,score1,dice)
            if extra_turn(score0,score1):
                same=1
        else:
            num_roll=strategy1(score1,score0)
            score1=score1+take_turn(num_roll,score0,dice)
    ...
    "*** YOUR CODE HERE ***"
    if flag==0:
        flag=say(score0,score1)
    else:
        flag=flag(score0,score1)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if(take_turn(score+free_bacon(opponent_score),opponent_score)):
        return 0
    else:
        return bacon_strategy  # Replace this statement
    # END PROBLEM 11
